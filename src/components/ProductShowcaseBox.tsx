        ...
        <div className="flex h-full">
          ...
          <div className="w-1/2 pl-6 flex flex-col justify-between">
            ...
            <div className="space-y-3">
              ...
              <Button className="w-full bg-primary hover:bg-secondary text-white font-sans py-2 text-sm transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            <Button className="w-full bg-primary hover:bg-secondary text-white font-sans py-4 text-xl transition-colors duration-300">
